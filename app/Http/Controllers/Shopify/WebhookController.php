...
class WebhookController extends Controller
{
    ...
    public function createOrderWebhook(Request $request)
    {
        ...
        $response = Http::withHeaders([
            ...
            'webhook' => [
                'topic' => 'orders/create',
                'address' => 'https://modaxlarge.codeven.co/webhook/shopify/order-create',
                'format' => 'json'
            ]
        ]);
        ...
        $response1 = Http::withHeaders([
            ...
            'webhook' => [
                'topic' => 'orders/paid',
                'address' => 'https://modaxlarge.codeven.co/webhook/shopify/order-paid',
                'format' => 'json'
            ]
        ]);
        ...
        $response2 = Http::withHeaders([
            ...
            'webhook' => [
                ...
                'address' => 'https://modaxlarge.codeven.co/webhook/shopify/order-cancelled',
                'format' => 'json'
            ]
        ]);
